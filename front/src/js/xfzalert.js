    ...
    */
    'alertConfirm':function (params) {
        swal({
            ...
            'confirmButtonText': params['confirmText'] ? params['confirmText'] : 'Yes',
            'cancelButtonText': params['cancelText'] ? params['cancelText'] : 'No',
    ...
    */
    'alertOneInput': function (params) {
        swal({
            ...
            'confirmButtonText': params['confirmText'] ? params['confirmText'] : 'Submit',
